        ...
        for (int part = 0; part < numParts; part++) {
            ...
            if (csRing.size() == 0 || csRing.size() > 3) {
                ...
                if (CoordinateSequences.isCCW(csRing)) {
                    ...
                    // clockwise
                    shells.add(ring);
                    shellsIndex.insert(ring.getEnvelopeInternal(), ring);
                }
            }
        }
...
/*
 * $Log: PolygonHandler.java,v $ Revision 1.9 2004/02/17 18:10:23 ianschneider changed to use
 * GeometryFactory for Geometry creation
 *
 ...
 *
 * Revision 1.4 2003/07/21 21:15:29 jmacgill small fix for shapefiles with an invalid hole (only 1
 * or 2 points)
 *
 ...
 *
 * Revision 1.3 2003/04/30 23:19:46 ianschneider Added construction of multi geometries for default
 ...
 *
 * Revision 1.1.2.5 2003/03/29 22:30:09 ianschneider For case of hole without shell - reverse hole,
 * add to shell list
 *
 * Revision 1.1.2.4 2003/03/26 19:30:30 ianschneider Made hack to reverse polygon records if they
 * contains only holes
 *
 * Revision 1.1.2.3 2003/03/12 15:30:18 ianschneider made ShapeType final for handlers - once
 ...
 *
 * Revision 1.3 2002/02/11 18:44:22 jmacgill replaced geometry constructions with calls to
 * geometryFactory.createX methods
 *
