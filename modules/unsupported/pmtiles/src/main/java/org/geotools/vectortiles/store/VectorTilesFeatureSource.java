...
public class VectorTilesFeatureSource extends ContentFeatureSource {
    ...
    /**
     * For vector tile layers, it's not enough to determine the best zoom level based on the
     * {@link TileStore#findBestZoomLevel(double, Strategy) tile matrix}, because the layer metadata also defines
     * layer-specific {@linkplain VectorLayer#minZoom() min} and {@linkplain VectorLayer#maxZoom() max} zoom levels.
     *
     * @param query
     * @return
     */
