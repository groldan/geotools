...
public class GeoParquetLocalFileTest extends GeoParquetTestBase {
    ...
    public void testSingleFileAccess() throws IOException {
        ...
        dataStore = createLocalDataStore(pointsFile.getAbsolutePath());
        ...
        assertTrue("Schema should have a geometry attribute", source.getSchema().getGeometryDescriptor() != null);
    ...
    public void testDirectoryAccess() throws IOException {
        ...
        dataStore = createLocalDataStore(directory.getAbsolutePath());
    ...
    public void testSpatialFilter() throws IOException {
        // Create the datastore with the local file
        dataStore = createLocalDataStore(support.getWorldgridDir().getAbsolutePath());
